...
class CreateTableStockTeste extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        ...
        Schema::create('investments.stocks_data_tests', function (Blueprint $table) {
            ...
            $table->unique(['stock_id','date'],'unique_index_stock_test');
            $table->timestamps();
            $table->softDeletes();
